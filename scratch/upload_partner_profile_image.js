...
async function main() {
  try {
    ...
    const srcPath = 'C:\\Users\\user\\.gemini\\antigravity\\brain\\4533860b-0498-4962-9458-418a4aa0e258\\media__1784179131293.jpg';
    ...
    const destFileName = `profileImage-9868605551-${timestamp}.jpg`;
    ...
    // 5. Update partner image in partners table
    await db.query('UPDATE partners SET image = ? WHERE id = ?', [destFileName, partner.id]);
    console.log(`Successfully updated partner profile image in database to ${destFileName}`);
